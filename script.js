...
// Añade este código al principio de tu script.js, después de las variables globales
...
function initStatsAnimation() {
    ...
    if (isVisible) {
        animateValue("stat1", 0, 1010, 2000);
        animateValue("stat2", 0, 869, 2000);
        animateValue("stat3", 0, 18236, 2000);
        animateValue("stat4", 0, 2600000, 2000);
