...
function finalizarCompra() {
    ...
    // Guardar el carrito actual para el checkout con timestamp
    ...
    // También guardar en cookies como respaldo adicional
    document.cookie = `carritoCheckout=${JSON.stringify(carritoConTimestamp)}; max-age=300; path=/; samesite=strict`;
